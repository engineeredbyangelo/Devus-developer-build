...
import { ToolCardVisual } from "./dashboard/ToolCardVisual";
...
export function ToolCard({ tool, index = 0, onClick }: ToolCardProps) {
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
    >
      <div className="glass glass-hover rounded-xl h-full flex flex-col overflow-hidden">
        {/* Glow effect on hover */}
        <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-10" />
